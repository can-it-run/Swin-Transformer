...
def build_loader(config):
    ...
    config.freeze()
    print(f"local rank {config.LOCAL_RANK} /  successfully build train dataset")
    dataset_val, _ = build_dataset(is_train=False, config=config)
    print(f"local rank {config.LOCAL_RANK} /  successfully build val dataset")
...
def build_dataset(is_train, config):
    ...
    if config.DATA.DATASET == "imagenet":
        prefix = "imagenet_val" if is_train else "imagenet_val"
